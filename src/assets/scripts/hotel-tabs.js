  ...
  const initSliders = () => {
    ...
    setTimeout(() => {
      ...
      document.querySelectorAll(nomerElementQuery).forEach(nomer => {
        ...
        const sliderPopupMobileElementQuery = ".HotelPage__NomerPopupPhotoSlider--Mobile";
        ...
        const sliderPopupMobile = new Splide(nomer.querySelector(sliderPopupMobileElementQuery), {
          type: "loop",
          autoplay: true,
          perPage: 1,
          perMove: 1,
        ...
        sliderPopupMobile.sync(sliderMobile).mount();

        sliderMobile.on("click", () => {
          nomer.querySelector(".HotelPage__NomerPopupPhotoSliderContainer").classList.add("HotelPage__NomerPopupPhotoSliderContainer--ActiveMobile");
        });
